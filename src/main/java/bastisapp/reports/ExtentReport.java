...
public class ExtentReport {
	...
	public void initializeReport() {
		...
		ExtentSparkReporter htmlReporter = new ExtentSparkReporter(
				System.getProperty("user.dir") + "/report/testReport_" + dateformat + ".html");
	...
	public static synchronized void logMessage(Status status, String desc, boolean screenshot) {
		...
		if (screenshot) {
			...
			try {
				image = MediaEntityBuilder.createScreenCaptureFromPath(captureScreenShot(BaseTest.getDriver(),
